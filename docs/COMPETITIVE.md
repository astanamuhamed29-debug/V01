...
```mermaid
quadrantChart
    title Competitive Positioning: Automation vs. Identity Depth
    x-axis Low Automation --> High Automation
    y-axis Shallow Identity --> Deep Identity
    quadrant-1 Our Target Zone
    quadrant-2 Active but Generic
    quadrant-3 Passive Tools
    quadrant-4 Automated but Impersonal
    SELF-OS: [0.85, 0.90]
    Obsidian: [0.10, 0.20]
    Roam Research: [0.15, 0.25]
    Mem AI: [0.45, 0.30]
    Notion AI: [0.40, 0.20]
    Motion: [0.75, 0.15]
    Reclaim AI: [0.70, 0.10]
    LifeOS: [0.55, 0.35]
    Replika: [0.30, 0.60]
    Woebot: [0.35, 0.55]
```
